...
public class TerminalTest extends TerminalTestCase {
    ...
    public void testCursorPositioning() throws Exception {
        withTerminalSized(10, 10)
                ...
                .placeCursorAndAssert(3, 5)
                .placeCursorAndAssert(2, 2)
                .enterString("A")
                .assertCursorAt(2, 3);
    }
    ...
    public void testLineDrawing() {
        ...
        withTerminalSized(4, 2)
                .enterString("\033)0\016qqq\0337\017\0338q")
                .assertLinesAre("────", "    ");
    }

    public void testSoftTerminalReset() {
        // See http://vt100.net/docs/vt510-rm/DECSTR and
        // https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=650304
    ...
    public void testTab() {
        withTerminalSized(11, 2)
                .enterString("01234567890\r\tXX")
                .assertLinesAre("01234567XX0", "           ");
        withTerminalSized(11, 2)
                .enterString("01234567890\033[44m\r\tXX")
                .assertLinesAre("01234567XX0", "           ");
    }
}
