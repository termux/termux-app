...
public class DeviceControlStringTest extends TerminalTestCase {
    ...
    private void assertCapabilityResponse(String cap, String expectedResponse) {
        ...
        assertEnteringStringGivesResponse(
                input, "\033P1+r" + hexEncode(cap) + "=" + hexEncode(expectedResponse) + "\033\\");
    }

    public void testReportColorsAndName() {
        // Request Termcap/Terminfo String. The string following the "q" is a list of names encoded
        // in
        // hexadecimal (2 digits per character) separated by ; which correspond to termcap or
        // terminfo key
        // names.
        // Two special features are also recognized, which are not key names: Co for termcap colors
        // (or colors
        ...
        // value of the
        // corresponding string that xterm would send, or DCS 0 + r P t ST for invalid requests. The
        // strings are
    ...
    public void testReallyLongDeviceControlString() {
        ...
        // The terminal should ignore the overlong DCS sequence and continue printing "aaa." and
        // fill at least the first two lines with
        // them:
        assertLineIs(0, "aaa");
        assertLineIs(1, "aaa");
    }
