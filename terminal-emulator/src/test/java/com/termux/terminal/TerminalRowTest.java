...
public class TerminalRowTest extends TestCase {
    ...
    public void testUnicode() {
        ...
        assertLineStartsWith(
                TWO_JAVA_CHARS_DISPLAY_WIDTH_ONE_1, TWO_JAVA_CHARS_DISPLAY_WIDTH_ONE_2, ' ');
    ...
    public void testSurrogateCharsWithNormalDisplayWidth() {
        ...
        for (int i = 0; i < 80; i++) {
            ...
            assertEquals(
                    i % 2 == 0 ? first : second,
                    Character.toCodePoint(row.mText[idx], row.mText[idx + 1]));
        }
        for (int i = 0; i < 80; i++) {
    ...
    public void testCrashATE145() {
        ...
        int[] points =
                new int[] {
                    0xC2541, 'a', '8', 0x73EE, 0x009F, 0x881F, 0x8324, 0xD4C9, 0xFFFD, 'B', 0x009B,
                    0x61C9, 'Z'
                };
        // int[] expected = new int[] { TerminalEmulator.UNICODE_REPLACEMENT_CHAR, 'a', '8', 0x73EE,
        // 0x009F, 0x881F, 0x8324, 0xD4C9, 0xFFFD,
        // 'B', 0x009B, 0x61C9, 'Z' };
        int currentColumn = 0;
        ...
        // charIndex++;
        // }
        // assertEquals("At index=" + i + ", charIndex=" + charIndex + ", char=" + (char) thisPoint,
        // points[i], thisPoint);
        // }
    }
