...
public class HistoryTest extends TerminalTestCase {
    ...
    public void testHistoryWithScrollRegion() {
        // "CSI P_s ; P_s r" - set Scrolling Region [top;bottom] (default = full size of window)
        // (DECSTBM).
        ...
        enterString("IJK")
                .assertLinesAre("111", "FGH", "IJK", "444")
                .assertHistoryStartsWith("CDE");
        enterString("LMN")
                .assertLinesAre("111", "IJK", "LMN", "444")
                .assertHistoryStartsWith("FGH", "CDE");
    }
}
