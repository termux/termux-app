...
public class CursorAndScreenTest extends TerminalTestCase {
    ...
    public void testDeleteCharacters() {
        ...
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[P")
                .assertLinesAre("ice  ", "     ");
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[2P")
                .assertLinesAre("ce   ", "     ");
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[2G\033[2P")
                .assertLinesAre("ne   ", "     ");
        // "${CSI}${n}P, the delete characters (DCH) sequence should cap characters to delete.
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[99P")
                .assertLinesAre("     ", "     ");
    ...
    public void testInsertMode() {
        ...
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[4hA")
                .assertLinesAre("Anice", "     ");
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[2G\033[4hA")
                .assertLinesAre("nAice", "     ");
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[4hABC")
                .assertLinesAre("ABCni", "     ");
        // With combining char U+0302.
        withTerminalSized(5, 2)
                .enterString("n\u0302ice")
                .enterString("\033[G\033[4hA")
                .assertLinesAre("An\u0302ice", "     ");
        withTerminalSized(5, 2)
                .enterString("n\u0302ice")
                .enterString("\033[G\033[4hAB")
                .assertLinesAre("ABn\u0302ic", "     ");
        withTerminalSized(5, 2)
                .enterString("n\u0302ic\u0302e")
                .enterString("\033[2G\033[4hA")
                .assertLinesAre("n\u0302Aic\u0302e", "     ");
        ...
        withTerminalSized(5, 2)
                .enterString("n\u0302\u0302i\u0302ce")
                .enterString("\033[GA")
                .assertLinesAre("Ai\u0302ce ", "     ");
        // ... and in last column:
        withTerminalSized(5, 2)
                .enterString("n\u0302\u0302ice!\u0302")
                .enterString("\033[5GA")
                .assertLinesAre("n\u0302\u0302iceA", "     ");
        withTerminalSized(5, 2)
                .enterString("nic\u0302e!\u0302")
                .enterString("\033[4G枝")
                .assertLinesAre("nic\u0302枝", "     ");
        withTerminalSized(5, 2)
                .enterString("nic枝\u0302")
                .enterString("\033[3GA")
                .assertLinesAre("niA枝\u0302", "     ");
        withTerminalSized(5, 2)
                .enterString("nic枝\u0302")
                .enterString("\033[3GA")
                .assertLinesAre("niA枝\u0302", "     ");
        ...
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[G\033[4h枝")
                .assertLinesAre("枝nic", "     ");
        withTerminalSized(5, 2)
                .enterString("nice")
                .enterString("\033[2G\033[4h枝")
                .assertLinesAre("n枝ic", "     ");
        withTerminalSized(5, 2)
                .enterString("n枝ce")
                .enterString("\033[G\033[4ha")
    ...
    public void testCursorHorizontalPositionAbsolute() {
        ...
        enterString("\033[?69h\033[2;3s\033[`")
                .assertCursorAt(0, 0)
                .enterString("\033[22`")
                .assertCursorAt(0, 3);
        // .. now with origin mode:
        enterString("\033[?6h\033[`")
                .assertCursorAt(0, 1)
                .enterString("\033[22`")
                .assertCursorAt(0, 2);
    }
    ...
    public void testCursorForward() {
        ...
        // If an attempt is made to move the cursor to the right of the right margin, the cursor
        ...
        withTerminalSized(6, 2)
                .enterString("\033[?69h\033[1;3s\033[44CAB")
                .assertLinesAre("  A   ", "B     ");
    }
    ...
    public void testCursorBack() {
        ...
        // If an attempt is made to move the cursor to the left of the left margin, the cursor stops
        // at the left margin:
        ...
        withTerminalSized(6, 2)
                .enterString("ABCD\033[?69h\033[2;6s\033[44DE")
                .assertLinesAre("AECD  ", "      ");
    }
    ...
    public void testCursorUp() {
        ...
        // If an attempt is made to move the cursor above the top margin, the cursor stops at the
        // top margin:
    ...
    public void testCursorDown() {
        ...
        // If an attempt is made to move the cursor below the bottom margin, the cursor stops at the
        // bottom margin:
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                ...
                assertEnteringStringGivesResponse(
                        "\033[6n", "\033[" + (i + 1) + ";" + (j + 1) + "R");
                // DECXCPR — Extended Cursor Position. Note that
                // http://www.vt100.net/docs/vt510-rm/DECXCPR says
                // the response is "${CSI}${LINE};${COLUMN};${PAGE}R" while xterm
                // (http://invisible-island.net/xterm/ctlseqs/ctlseqs.html)
                // drops the question mark. Expect xterm behaviour here.
                assertEnteringStringGivesResponse(
                        "\033[?6n", "\033[?" + (i + 1) + ";" + (j + 1) + ";1R");
            }
        }
    }
     ...
     *
     * <p>We do not want to color already written cells when tabbing over them.
     */
    ...
    public void testCursorSaveRestoreLocation() {
        ...
        withTerminalSized(4, 2)
                .enterString("t\0337est\r\nme\0338ry ")
                .assertLinesAre("try ", "me  ");
        // ANSI.SYS save/restore
        withTerminalSized(4, 2)
                .enterString("t\033[sest\r\nme\033[ury ")
                .assertLinesAre("try ", "me  ");
        // Alternate screen enter/exit
        withTerminalSized(4, 2)
                .enterString("t\033[?1049h\033[Hest\r\nme")
                .assertLinesAre("est ", "me  ")
                .enterString("\033[?1049lry")
                .assertLinesAre("try ", "    ");
    }
