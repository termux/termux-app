...
public abstract class TermuxServiceApplication extends Application {
    private static final String TAG = "TermuxServiceApplication";
    private static TermuxServiceApplication sApplication;
