#!/usr/bin/env bash
clear ; cowsay "Okay, Editor tutorial!"
read user_response
...
read user_response
clear ; cowsay "You can hit enter again to open the file in your editor! or cancel the command with Ctrl+c"
read user_response
clear ; cowsay "I will cancel with Ctrl+c for now"
read user_response
tel-typewriter -k C-c -t Tutorial.bottom
clear ; cowsay "you can also start tel-edit with the shortcut: Alt+e"
read user_response
