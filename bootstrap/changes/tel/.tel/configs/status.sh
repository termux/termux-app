...
export STATUS_RELOAD=1 #time to sleep betweem status pane refresh (higher may save battery) [seconds]
export STATUS_TIMEOUT=6 #timeout for status scripts (if status not fully loading try increasing) [seconds]
