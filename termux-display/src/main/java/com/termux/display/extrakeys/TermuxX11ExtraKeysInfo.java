...
import com.termux.display.extrakeys.TermuxX11ExtraKeysConstants.EXTRA_KEY_DISPLAY_MAPS;
...
/**
 * A {@link Class} that defines the info needed by {@link TermuxExtraKeysView} to display the extra key
 * views.
 *
 ...
 * {@link com.termux.display.utils.TermuxX11ExtraKeys} which is an implementation of the interface,
...
public class TermuxX11ExtraKeysInfo {
     ...
     *              {@link TermuxX11ExtraKeysConstants.ExtraKeyDisplayMap} that defines the display text
