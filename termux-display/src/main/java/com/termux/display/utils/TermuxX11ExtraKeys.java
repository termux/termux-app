...
import static com.termux.shared.termux.extrakeys.TermuxX11ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
...
public class TermuxX11ExtraKeys implements TermuxExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.termux.display.start_preferences_activity";
