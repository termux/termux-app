 ...
 *
 * <ul>
 *   <li>http://www.mongrel-phones.com.au/default/how_to_make_a_local_service_and_bind_to_it_in_android
 *   <li>https://code.google.com/p/android/issues/detail?id=6426
 * </ul>
 *
 * about memory leaks.
 */
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
    ...
    /**
     * The {@link TermuxActivity} broadcast receiver for various things like terminal style
     * configuration changes.
     */
    private final BroadcastReceiver mTermuxActivityBroadcastReceiver =
            new TermuxActivityBroadcastReceiver();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTermuxActivityRootView.setOnApplyWindowInsetsListener(
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(
                    LOG_TAG, "TermuxActivity failed to start TermuxService", e);
            Logger.showToast(
                    this,
                    getString(
                            e.getMessage() != null
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        ...
        if (mTermuxService.isTermuxSessionsEmpty()) {
                ...
                TermuxInstaller.setupBootstrapIfNeeded(
                        ...
                        () -> {
                            ...
                            try {
                                ...
                                mTermuxTerminalSessionActivityClient.addNewSession(
                                        launchFailsafe, null);
            ...
            // then the original intent will be re-delivered, resulting in a new session being
            // re-added
            // each time.
    ...
    private void setMargins() {
        ...
        ViewUtils.setLayoutMarginsInDp(
                relativeLayout, marginHorizontal, marginVertical, marginHorizontal, marginVertical);
    }

    public void addTermuxActivityRootViewGlobalLayoutListener() {
        getTermuxActivityRootView()
                .getViewTreeObserver()
                .addOnGlobalLayoutListener(getTermuxActivityRootView());
    }
    ...
    public void removeTermuxActivityRootViewGlobalLayoutListener() {
        if (getTermuxActivityRootView() != null)
            getTermuxActivityRootView()
                    .getViewTreeObserver()
                    .removeOnGlobalLayoutListener(getTermuxActivityRootView());
    }
    ...
    private void setTermuxTerminalViewAndClients() {
        ...
        mTermuxTerminalViewClient =
                new TermuxTerminalViewClient(this, mTermuxTerminalSessionActivityClient);
    ...
    private void setTermuxSessionsListView() {
        ...
        mTermuxSessionListViewController =
                new TermuxSessionsListViewController(this, mTermuxService.getTermuxSessions());
    ...
    private void setNewSessionButtonView() {
        ...
        newSessionButton.setOnClickListener(
                v -> mTermuxTerminalSessionActivityClient.addNewSession(false, null));
    ...
    private void setToggleKeyboardView() {
        findViewById(R.id.toggle_keyboard_button)
                .setOnClickListener(
                        v -> {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        menu.add(
                ...
                Menu.NONE,
                R.string.action_share_transcript);
        if (!DataUtils.isNullOrEmpty(mTerminalView.getStoredSelectedText()))
            menu.add(
                    Menu.NONE,
                    CONTEXT_MENU_SHARE_SELECTED_TEXT,
                    Menu.NONE,
                    R.string.action_share_selected_text);
        if (addAutoFillMenu)
            menu.add(
                    Menu.NONE,
                    CONTEXT_MENU_AUTOFILL_ID,
                    Menu.NONE,
                    R.string.action_autofill_password);
        menu.add(
                Menu.NONE,
        ...
        menu.add(
                        ...
                        getResources()
                                .getString(
                                        R.string.action_kill_process, getCurrentSession().getPid()))
        ...
        menu.add(
                ...
                .setCheckable(true)
                .setChecked(mPreferences.shouldKeepScreenOn());
    ...
    private void showStylingDialog() {
        ...
        stylingIntent.setClassName(
                ...
                TermuxConstants.TERMUX_STYLING.TERMUX_STYLING_ACTIVITY_NAME);
        try {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(
                            R.string.action_styling_install,
                            (dialog, which) ->
    ...
    /**
     * For processes to access primary external storage (/sdcard, /storage/emulated/0,
     * ~/storage/shared), termux needs to be granted legacy WRITE_EXTERNAL_STORAGE or
     * MANAGE_EXTERNAL_STORAGE permissions if targeting targetSdkVersion 30 (android 11) and running
     * on sdk 30 (android 11) and higher.
     */
                ...
                if (PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(
                                ...
                                LOG_TAG,
                                getString(
                                        com.termux.shared.R.string
                                                .msg_storage_permission_granted_on_request));
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(
                                ...
                                getString(
                                        com.termux.shared.R.string
                                                .msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
                    ...
                    case TERMUX_ACTIVITY.ACTION_RELOAD_STYLE:
                        ...
                        reloadActivityStyling(
                                intent.getBooleanExtra(
                                        TERMUX_ACTIVITY.EXTRA_RECREATE_ACTIVITY, true));
                        return;
    ...
    private void reloadActivityStyling(boolean recreateActivity) {
        if (mProperties != null) {
            ...
            if (mExtraKeysView != null) {
                ...
                mExtraKeysView.reload(
                        mTermuxTerminalExtraKeys.getExtraKeysInfo(), mTerminalToolbarDefaultHeight);
            }
        ...
        // will be called again. Extra keys input text, terminal sessions and transcripts will be
        // preserved.
        if (recreateActivity) {
