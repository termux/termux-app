...
public class NotificationUtils {
     ...
     *     NotificationUtils.NOTIFICATION_MODE_*}. The builder returned will be {@code null} if
     *     {@link #NOTIFICATION_MODE_NONE} is passed. That case should ideally be handled before
    ...
    /**
     * Setup the notification channel if Android version is greater than or equal to {@link
    ...
    public static Notification.Builder setNotificationDefaults(
            Notification.Builder builder, final int notificationMode) {

        // TODO: setDefaults() is deprecated and should also implement setting notification mode via
        // notification channel
        switch (notificationMode) {
            case NOTIFICATION_MODE_NONE:
                Logger.logWarn(
                        LOG_TAG,
                        "The NOTIFICATION_MODE_NONE passed to setNotificationDefaults(), force"
            ...
            default:
                Logger.logError(
                        LOG_TAG,
                        "Invalid notificationMode: \""
                                + notificationMode
                                + "\" passed to setNotificationDefaults()");
                break;
        }
