...
public class ReflectionUtils {
    ...
    private static boolean HIDDEN_API_REFLECTION_RESTRICTIONS_BYPASSED =
        ...
        if (!HIDDEN_API_REFLECTION_RESTRICTIONS_BYPASSED
            ...
            try {
                ...
                Logger.logStackTraceWithMessage(
                        LOG_TAG, "Failed to bypass hidden API reflection restrictions", t);
            }
     ...
     * @return Returns the {@link FieldInvokeResult} of invoking the field. The {@link
     *     FieldInvokeResult#success} will be {@code true} if invoking the field was successful,
     *     otherwise {@code false}. The {@link FieldInvokeResult#value} will contain the field
     *     {@link Object} value.
     */
    @NonNull
    public static <T> FieldInvokeResult invokeField(
            @NonNull Class<? extends T> clazz, @NonNull String fieldName, T object) {
        try {
     ...
     * @param obj The {@link Object} the method should be invoked from.
     * @param args The arguments to pass to the method.
     * @return Returns the {@link MethodInvokeResult} of invoking the method. The {@link
     *     MethodInvokeResult#success} will be {@code true} if invoking the method was successful,
     *     otherwise {@code false}. The {@link MethodInvokeResult#value} will contain the {@link
     *     Object} returned by the method.
     */
    @NonNull
    public static MethodInvokeResult invokeMethod(
            @NonNull Method method, Object obj, Object... args) {
        try {
            method.setAccessible(true);
    ...
    public static Constructor<?> getConstructor(
            @NonNull String className, Class<?>... parameterTypes) {
        try {
            return getConstructor(Class.forName(className), parameterTypes);
        } catch (Exception e) {
            Logger.logStackTraceWithMessage(
                    LOG_TAG,
                    "Failed to get constructor for \""
                            + className
                            + "\" class with parameter types: "
                            + Arrays.toString(parameterTypes),
                    e);
     ...
     * @return Returns the {@link Constructor} if getting the it was successful, otherwise {@code
     *     null}.
     */
    @Nullable
    public static Constructor<?> getConstructor(
            @NonNull Class<?> clazz, Class<?>... parameterTypes) {
        try {
     ...
     * @return Returns the new instance if invoking the constructor was successful, otherwise {@code
     *     null}.
     */
    @Nullable
