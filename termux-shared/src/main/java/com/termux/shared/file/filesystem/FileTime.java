...
/**
 * Represents the value of a file's time stamp attribute. For example, it may represent the time
 * that the file was last {@link FileAttributes#lastModifiedTime() modified}, {@link
 * FileAttributes#lastAccessTime() accessed}, or {@link FileAttributes#creationTime() created}.
 *
 * <p>Instances of this class are immutable.
 *
 * <p>https://cs.android.com/android/platform/superproject/+/android-11.0.0_r3:libcore/ojluni/src/main/java/java/nio/file/attribute/FileTime.java
 *
 * @since 1.7
...
public final class FileTime {
    /**
     * The unit of granularity to interpret the value. Null if this {@code FileTime} is converted
     * from an {@code Instant}, the {@code value} and {@code unit} pair will not be used in this
     * scenario.
     */
     ...
     *
     * <p>Conversion from a coarser granularity that would numerically overflow saturate to {@code
