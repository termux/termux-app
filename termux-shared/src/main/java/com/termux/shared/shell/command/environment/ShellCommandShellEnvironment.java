...
public class ShellCommandShellEnvironment {
    ...
    public static final String ENV_SHELL_CMD__APP_SHELL_NUMBER_SINCE_BOOT =
            SHELL_CMD_ENV_PREFIX + "APP_SHELL_NUMBER_SINCE_BOOT";

    /**
     * Environment variable for the {{@link ExecutionCommand.Runner#TERMINAL_SESSION} number since
     * boot.
     */
    public static final String ENV_SHELL_CMD__TERMINAL_SESSION_NUMBER_SINCE_BOOT =
            SHELL_CMD_ENV_PREFIX + "TERMINAL_SESSION_NUMBER_SINCE_BOOT";

    /**
     * Environment variable for the {@link ExecutionCommand.Runner#APP_SHELL} number since app
     * start.
     */
    public static final String ENV_SHELL_CMD__APP_SHELL_NUMBER_SINCE_APP_START =
     ...
     * app start.
     */
    public static final String ENV_SHELL_CMD__TERMINAL_SESSION_NUMBER_SINCE_APP_START =
    ...
    public HashMap<String, String> getEnvironment(
        ...
        ShellEnvironmentUtils.putToEnvIfSet(
                environment, ENV_SHELL_CMD__RUNNER_NAME, runner.getName());
        ShellEnvironmentUtils.putToEnvIfSet(
                environment, ENV_SHELL_CMD__PACKAGE_NAME, currentPackageContext.getPackageName());
        ShellEnvironmentUtils.putToEnvIfSet(
                environment, ENV_SHELL_CMD__SHELL_ID, String.valueOf(executionCommand.id));
        ShellEnvironmentUtils.putToEnvIfSet(
                environment, ENV_SHELL_CMD__SHELL_NAME, executionCommand.shellName);
