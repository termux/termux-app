...
public abstract class UnixShellEnvironment implements IShellEnvironment {
    ...
    /**
     * Environment variable for the represent the sequence of directory paths separated with colons
     * ":" that should be searched in for dynamic shared libraries to link programs against.
     */
    ...
    /**
     * Environment variable for the terminal type for which output is to be prepared. This
     * information is used by utilities and application programs wishing to exploit special
     * capabilities specific to a terminal. The format and allowable values of this environment
     * variable are unspecified.
     */
    public static final String ENV_TERM = "TERM";

    /**
     * Environment variable for the path of a directory made available for programs that need a
     * place to create temporary files.
     */
    public static final String ENV_TMPDIR = "TMPDIR";

    /** Names for common/supported login shell binaries. */
    public static final String[] LOGIN_SHELL_BINARIES =
            new String[] {"login", "bash", "zsh", "fish", "sh"};

    @NonNull
    public abstract HashMap<String, String> getEnvironment(
    ...
    @NonNull
    @Override
    public String[] setupShellCommandArguments(
    ...
    @NonNull
    @Override
    public abstract HashMap<String, String> setupShellCommandEnvironment(
