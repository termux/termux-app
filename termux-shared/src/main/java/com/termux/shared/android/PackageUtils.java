...
public class PackageUtils {
     ...
     *
     * @param context The {@link Context} to use to get the {@link Context} of the {@code
     *     packageName}.
     ...
     */
    @Nullable
    public static Context getContextForPackage(
            @NonNull final Context context, String packageName, int flags) {
        try {
     ...
     * @param helpUrl The help user to add to {@link
    ...
    public static Context getContextForPackageOrExitApp(
        ...
        if (packageContext == null && exitAppOnError) {
            String errorMessage =
                    context.getString(
                            R.string.error_get_package_context_failed_message, packageName);
     ...
     */
    @Nullable
    public static PackageInfo getPackageInfoForPackage(
            @NonNull final Context context, final int flags) {
    ...
    @Nullable
    public static PackageInfo getPackageInfoForPackage(
            @NonNull final Context context, @NonNull final String packageName, final int flags) {
        try {
     ...
     * @param context The {@link Context} for operations.
     * @param packageName The package name of the package.
     * @return Returns the {@link ApplicationInfo}. This will be {@code null} if an exception is
     *     raised.
     */
    @Nullable
    public static ApplicationInfo getApplicationInfoForPackage(
            @NonNull final Context context, @NonNull final String packageName) {
     ...
     */
    @Nullable
    public static Integer getApplicationInfoPrivateFlagsForPackage(
            @NonNull final ApplicationInfo applicationInfo) {
        ReflectionUtils.bypassHiddenAPIReflectionRestrictions();
        try {
            return (Integer)
                    ReflectionUtils.invokeField(
                                    ApplicationInfo.class, "privateFlags", applicationInfo)
                            .value;
        } catch (Exception e) {
            // ClassCastException may be thrown
            Logger.logStackTraceWithMessage(
                    LOG_TAG, "Failed to get privateFlags field value for ApplicationInfo class", e);
            return null;
        }
    }
     ...
     *
     * <p>String retrieved from the seinfo tag found in selinux policy. This value can be set
     * through the mac_permissions.xml policy construct. This value is used for setting an SELinux
     * security context on the process as well as its data directory.
     *
     ...
     */
    @Nullable
    public static String getApplicationInfoSeInfoForPackage(
            @NonNull final ApplicationInfo applicationInfo) {
        ReflectionUtils.bypassHiddenAPIReflectionRestrictions();
        try {
            return (String)
            ...
            // ClassCastException may be thrown
            Logger.logStackTraceWithMessage(
                    LOG_TAG, "Failed to get seInfo field value for ApplicationInfo class", e);
            return null;
        }
    }
     ...
     *
     * <p>Also check {@link #getApplicationInfoSeInfoForPackage(ApplicationInfo)}.
     *
     * @param applicationInfo The {@link ApplicationInfo} for the package.
     * @return Returns the selinux info user or {@code null} if an exception was raised.
     */
    @Nullable
    public static String getApplicationInfoSeInfoUserForPackage(
            @NonNull final ApplicationInfo applicationInfo) {
        ...
        try {
            return (String)
                    ReflectionUtils.invokeField(
                                    ApplicationInfo.class, "seInfoUser", applicationInfo)
                            .value;
        } catch (Exception e) {
            // ClassCastException may be thrown
            Logger.logStackTraceWithMessage(
                    LOG_TAG, "Failed to get seInfoUser field value for ApplicationInfo class", e);
            return null;
        }
    }
    ...
    public static Integer getApplicationInfoStaticIntFieldValue(@NonNull String fieldName) {
        ...
        try {
            return (Integer)
                    ReflectionUtils.invokeField(ApplicationInfo.class, fieldName, null).value;
        } catch (Exception e) {
            // ClassCastException may be thrown
            Logger.logStackTraceWithMessage(
                    LOG_TAG,
     ...
     */
    @Nullable
    public static Boolean isApplicationInfoPrivateFlagSetForPackage(
            @NonNull String flagToCheckName, @NonNull final ApplicationInfo applicationInfo) {
     ...
     * @return Returns the {@code android:name} attribute.
     */
    public static String getAppNameForPackage(
            @NonNull final Context context, @NonNull final ApplicationInfo applicationInfo) {
    ...
    /**
     * Check if the app associated with the {@code context} has {@link
     * ApplicationInfo#FLAG_DEBUGGABLE} set.
     *
     * @param context The {@link Context} for the package.
    ...
    /**
     * Check if the app associated with the {@code applicationInfo} has {@link
     * ApplicationInfo#FLAG_DEBUGGABLE} set.
     *
     * @param applicationInfo The {@link ApplicationInfo} for the package.
     * @return Returns {@code true} if app is debuggable, otherwise {@code false}.
     */
    public static boolean isAppForPackageADebuggableBuild(
            @NonNull final ApplicationInfo applicationInfo) {
    ...
    /**
     * Check if the app associated with the {@code context} has {@link
     * ApplicationInfo#FLAG_EXTERNAL_STORAGE} set.
     *
     * @param context The {@link Context} for the package.
     * @return Returns {@code true} if app is installed on external storage, otherwise {@code
     *     false}.
     */
     ...
     *
     * @param context The {@link Context} for the package.
     * @return Returns {@code true} if app has requested legacy external storage, otherwise {@code
     *     false}. This will be {@code null} if an exception is raised.
     */
    @Nullable
    ...
    public static Boolean hasRequestedLegacyExternalStorage(
            @NonNull final ApplicationInfo applicationInfo) {
        return isApplicationInfoPrivateFlagSetForPackage(
                "PRIVATE_FLAG_REQUEST_LEGACY_EXTERNAL_STORAGE", applicationInfo);
    }
     ...
     */
    @Nullable
    public static Integer getVersionCodeForPackage(
            @NonNull final Context context, @NonNull final String packageName) {
     ...
     */
    @Nullable
    public static String getVersionNameForPackage(
            @NonNull final Context context, @NonNull final String packageName) {
    ...
    /**
     * Get the {@code SHA-256 digest} of signing certificate for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the {@code SHA-256 digest}. This will be {@code null} if an exception is
     *     raised.
     */
    @Nullable
    public static String getSigningCertificateSHA256DigestForPackage(
    ...
    public static String getSigningCertificateSHA256DigestForPackage(
        ...
        try {
            ...
            PackageInfo packageInfo =
                    getPackageInfoForPackage(context, packageName, PackageManager.GET_SIGNATURES);
            if (packageInfo == null) return null;
            return DataUtils.bytesToHex(
    ...
    public static Long getUserIdForPackage(@NonNull Context context) {
        ...
        return userManager.getSerialNumberForUser(
                UserHandle.getUserHandleForUid(getUidForPackage(context)));
    }
     ...
     *
     * @param context The {@link Context} for operations.
     * @return Returns {@code true} if the current user is the primary user, otherwise [@code
     *     false}.
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
     ...
     * Note that some apps have multiple processes for the app like with
     * `android:process=":background"` attribute in AndroidManifest.xml.
     *
     * @param context The {@link Context} for operations.
    ...
    /**
     * Check if app is installed and enabled. This can be used by external apps that don't share
     * `sharedUserId` with the an app.
     *
     * <p>If your third-party app is targeting sdk `30` (android `11`), then it needs to add package
     * name to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... package_name/......}
     * BLOCKED` errors in `logcat` and {@link PackageManager.NameNotFoundException} may be thrown.
     * `RUN_COMMAND` intent won't work either. Check
     ...
     * for more info.
     *
     * <p>{@code <manifest <queries> <package android:name="com.termux" /> </queries>
     *
     * <p><application .... </application> </manifest> }
     *
     * @param context The context for operations.
     * @param appName The name of the app.
     * @param packageName The package name of the package.
     * @return Returns {@code errmsg} if {@code packageName} is not installed or disabled, otherwise
     *     {@code null}.
     */
    public static String isAppInstalled(
            @NonNull final Context context, String appName, String packageName) {
        String errmsg = null;
        ...
        if (!isAppEnabled)
            errmsg =
                    context.getString(
                            R.string.error_app_not_installed_or_disabled_warning,
                            appName,
                            packageName);
    ...
    /**
     * Wrapper for {@link #setComponentState(Context, String, String, boolean, String, boolean,
     * boolean)} with {@code alwaysShowToast} {@code true}.
     */
    public static String setComponentState(
            @NonNull final Context context,
        ...
        return setComponentState(
                context, packageName, className, newState, toastString, showErrorMessage, true);
    }

    /**
     * Enable or disable a {@link ComponentName} with a call to {@link
     ...
     * @param alwaysShowToast If toast should always be shown even if current state matches new
     *     state.
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                Boolean currentlyDisabled =
                        PackageUtils.isComponentDisabled(context, packageName, className, false);
                if (currentlyDisabled == null)
                    throw new UnsupportedOperationException(
                            "Failed to find if component currently disabled");

                Boolean setState = null;
                if (newState && currentlyDisabled) setState = true;
                else if (!newState && !currentlyDisabled) setState = false;
            ...
            String errmsg =
                    context.getString(
                                    newState
                                            ? R.string.error_enable_component_failed
                                            : R.string.error_disable_component_failed,
                                    packageName,
                                    className)
                            + ": "
                            + e.getMessage();
    ...
    /**
     * Check if state of a {@link ComponentName} is {@link
     * PackageManager#COMPONENT_ENABLED_STATE_DISABLED} with a call to {@link
        ...
        try {
            ...
            if (logErrorMessage)
                Logger.logStackTraceWithMessage(
                        LOG_TAG,
                        context.getString(
                                R.string.error_get_component_state_failed, packageName, className),
                        e);
        }
     ...
     */
    public static boolean doesActivityComponentExist(
            @NonNull final Context context,
            @NonNull String packageName,
            @NonNull String className,
            int flags) {
