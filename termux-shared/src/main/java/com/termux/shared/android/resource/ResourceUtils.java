...
public class ResourceUtils {
    ...
    /**
     * Wrapper for {@link #getResourceId(Context, String, String, String, boolean)} without {@code
     * defPackage}.
     */
    @Nullable
     ...
     * @param defType Optional default resource type to find, if "type/" is not included in the
     *     name. Can be null to require an explicit type.
     * @param defPackage Optional default package to find, if "package:" is not included in the
     *     name. Can be null to require an explicit package.
     ...
     *
     * <p>This is a wrapper for {@link #getResourceId(Context, String, String, String, boolean)}.
     */
    @Nullable
    public static Integer getColorResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
     ...
     */
    @Nullable
    public static Integer getDrawableResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
     ...
     */
    @Nullable
    public static Integer getIdResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
     ...
     */
    @Nullable
    public static Integer getLayoutResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
     ...
     */
    @Nullable
    public static Integer getStringResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
     ...
     */
    @Nullable
    public static Integer getStyleResourceId(
            @NonNull Context context,
            String name,
            @Nullable String defPackage,
            boolean logErrorMessage) {
