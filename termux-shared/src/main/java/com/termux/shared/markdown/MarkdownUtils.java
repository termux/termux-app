...
public class MarkdownUtils {
    ...
    public static String getMarkdownCodeForString(String string, boolean codeBlock) {
        ...
        if (codeBlock) backticksCountToUse = maxConsecutiveBackTicksCount + 3;
        else backticksCountToUse = maxConsecutiveBackTicksCount + 1;
        ...
        if (codeBlock) return backticksToUse + "\n" + string + "\n" + backticksToUse;
        else {
    ...
    public static String getLiteralSingleLineMarkdownStringEntry(
            String label, Object object, String def) {
    ...
    public static String getSingleLineMarkdownStringEntry(String label, Object object, String def) {
        if (object != null)
            return "**"
                    + label
                    + "**: "
                    + getMarkdownCodeForString(object.toString(), false)
                    + "  ";
    ...
    /**
     * Check following for more info: https://github.com/noties/Markwon/tree/v4.6.2/app-sample
                            ...
                            public void configureVisitor(@NonNull MarkwonVisitor.Builder builder) {
                                builder.on(
                                        ...
                                        (visitor, fencedCodeBlock) -> {
                                            // we actually won't be applying code spans here, as our
                                            // custom xml view will
                                            // draw background and apply mono typeface
                                            //
                                            // NB the `trim` operation on literal (as code will have
                                                    ...
                                                    new Object[] {
                                                        new BackgroundColorSpan(
                                                                ContextCompat.getColor(
                                                                        context,
                                                                        R.color
                                                                                .background_markdown_code_inline)),
                                                    });
                                }
                            }
                        })
                        ...
                        new AbstractMarkwonPlugin() {
                            ...
                            public void configureSpansFactory(
                                ...
                                builder.setFactory(
                                        ...
                                        .setFactory(
                                                Strikethrough.class,
                                                (configuration, props) -> new StrikethroughSpan())
                                        ...
                                        .setFactory(
                                                ListItem.class,
                                                (configuration, props) -> new BulletSpan());
                            }
                        })
                .build();
    }
