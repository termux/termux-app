...
/**
 * A class that defines shared constants of the SharedPreferences used by Termux app and its
 * plugins. This class will be hosted by termux-shared lib and should be imported by other termux
 * plugin apps as is instead of copying constants to random classes. The 3rd party apps can also
 * import it for interacting with termux apps. If changes are made to this file, increment the
 * version number and add an entry in the Changelog section above.
 */
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * Defines the key for whether to show terminal toolbar containing extra keys and text input
         * field.
         */
        ...
        /**
         * Defines the key for whether the soft keyboard will be enabled only if no hardware
         * keyboard attached, for cases where users want to use a hardware keyboard instead.
         */
        public static final String KEY_SOFT_KEYBOARD_ENABLED_ONLY_IF_NO_HARDWARE =
                "soft_keyboard_enabled_only_if_no_hardware";

        public static final boolean DEFAULT_VALUE_KEY_SOFT_KEYBOARD_ENABLED_ONLY_IF_NO_HARDWARE =
                false;
        ...
        /**
         * The {@link ExecutionCommand.Runner#TERMINAL_SESSION} number after termux app process
         * since boot.
         */
        public static final String KEY_TERMINAL_SESSION_NUMBER_SINCE_BOOT =
        ...
        public static final String KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED =
                "terminal_view_key_logging_enabled";

        public static final boolean DEFAULT_VALUE_TERMINAL_VIEW_KEY_LOGGING_ENABLED = false;

        /**
         * Defines the key for whether flashes and notifications for plugin errors are enabled or
         * not.
         */
        public static final String KEY_PLUGIN_ERROR_NOTIFICATIONS_ENABLED =
        ...
        public static final String KEY_CRASH_REPORT_NOTIFICATIONS_ENABLED =
    ...
    public static final class TERMUX_API_APP {
        ...
        public static final String KEY_LAST_PENDING_INTENT_REQUEST_CODE =
                "last_pending_intent_request_code";
