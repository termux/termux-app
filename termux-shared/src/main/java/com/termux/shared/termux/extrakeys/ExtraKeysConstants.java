...
public class ExtraKeysConstants {
     ...
     * ExtraKeysView#setRepetitiveKeys(List)}.
     */
    ...
    /**
     * HashMap that implements Python dict.get(key, default) function. Default java.util .get(key)
     * is then the same as .get(key, null);
     */
    ...
    public static class EXTRA_KEY_DISPLAY_MAPS {
        ...
        public static final ExtraKeyDisplayMap CLASSIC_ARROWS_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
        ...
        public static final ExtraKeyDisplayMap WELL_KNOWN_CHARACTERS_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
        ...
        public static final ExtraKeyDisplayMap LESS_KNOWN_CHARACTERS_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
                        ...
                        // depending on context, hence the diagonal
        ...
        public static final ExtraKeyDisplayMap ARROW_TRIANGLE_VARIATION_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
        ...
        public static final ExtraKeyDisplayMap NOT_KNOWN_ISO_CHARACTERS =
                new ExtraKeyDisplayMap() {
                    {
                        ...
                        put(
                                ...
                                "⎈"); // ISO character "U+2388 ⎈ HELM SYMBOL" is unknown to people
                                      // and never printed on computers, however "U+25C7 ◇ WHITE
                                      // DIAMOND" is a nice presentation, and "^" for terminal app
                                      // and mac is often used
                        put(
                                "ALT",
                                "⎇"); // ISO character "U+2387 ⎇ ALTERNATIVE KEY SYMBOL'" is unknown
                                      // to people and only printed as the Option key "⌥" on Mac
                                      // computer
                        put(
                                "ESC",
                                "⎋"); // ISO character "U+238B ⎋ BROKEN CIRCLE WITH NORTHWEST ARROW"
                                      // is unknown to people and not often printed on computers
                    }
                };

        public static final ExtraKeyDisplayMap NICER_LOOKING_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
        ...
        /** Full Iso */
        public static final ExtraKeyDisplayMap FULL_ISO_CHAR_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
        ...
        /** Only arrows */
        public static final ExtraKeyDisplayMap ARROWS_ONLY_CHAR_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
                        putAll(CLASSIC_ARROWS_DISPLAY);
        ...
        public static final ExtraKeyDisplayMap LOTS_OF_ARROWS_CHAR_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
                        putAll(CLASSIC_ARROWS_DISPLAY);
                        putAll(WELL_KNOWN_CHARACTERS_DISPLAY);
        ...
        public static final ExtraKeyDisplayMap DEFAULT_CHAR_DISPLAY =
                new ExtraKeyDisplayMap() {
                    {
                        putAll(CLASSIC_ARROWS_DISPLAY);
                        putAll(WELL_KNOWN_CHARACTERS_DISPLAY);
    ...
    public static final ExtraKeyDisplayMap CONTROL_CHARS_ALIASES =
            new ExtraKeyDisplayMap() {
                {
                    put("ESCAPE", "ESC");
                    put("CONTROL", "CTRL");
