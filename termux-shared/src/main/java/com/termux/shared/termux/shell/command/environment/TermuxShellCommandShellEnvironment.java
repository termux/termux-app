...
public class TermuxShellCommandShellEnvironment extends ShellCommandShellEnvironment {
    ...
    public HashMap<String, String> getEnvironment(
        ...
        HashMap<String, String> environment =
                super.getEnvironment(currentPackageContext, executionCommand);

        TermuxAppSharedPreferences preferences =
                TermuxAppSharedPreferences.build(currentPackageContext);
        ...
        if (ExecutionCommand.Runner.APP_SHELL.equalsRunner(executionCommand.runner)) {
            ...
            ShellEnvironmentUtils.putToEnvIfSet(
                    ...
                    String.valueOf(
                            TermuxShellManager.getAndIncrementAppShellNumberSinceAppStart()));
            ...
            ShellEnvironmentUtils.putToEnvIfSet(
                    ...
                    String.valueOf(
                            TermuxShellManager
                                    .getAndIncrementTerminalSessionNumberSinceAppStart()));
        } else {
            return environment;
        }
