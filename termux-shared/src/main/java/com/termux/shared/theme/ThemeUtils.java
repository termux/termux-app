...
public class ThemeUtils {
    ...
    public static boolean shouldEnableDarkTheme(Context context, String name) {
        if (NightMode.TRUE.getName().equals(name)) return true;
        else if (NightMode.FALSE.getName().equals(name)) return false;
     ...
     *     {@link AppCompatActivity} or one with which a theme attribute can be got. Do no use
     *     application context.
